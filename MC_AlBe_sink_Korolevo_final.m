...
load mc_source_Korolevo_constrained68_maxpluck1.mat                               % Load file with sink simulations
name = 'mc_sink_Korolevo_constrained68_maxpluck1';                                % Filename for saving
...
lon = 23.1705;                                                  % Longitude of sampling siteoburial 
elev = 232;                                                     % Elevation of sampling site [m asl.]

%*********** Sink history ************
min_sink_time = 0;                                      % Possible burial times in sink [Myr]         
max_sink_time = 2;                                      % Possible burial times in sink [Myr]
min_rate = 300;                                         % Possible erosion/accumulation rates in sink [g/cm2/Myr]
max_rate = 2000;                                       % Possible erosion/accumulation rates in sink [g/cm2/Myr]
