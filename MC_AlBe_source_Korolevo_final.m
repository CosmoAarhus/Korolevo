...
name = 'mc_source_Korolevo_constrained68_maxpluck1.mat';                                 % Filename
Nsim = 1e7;                                                  % Number of simulations

%*********** Geographical settings ************
lat = 48.1769;                                               % Latitude of sampling site
lon = 23.1705;                                               % Longitude of sampling site
sink_elev = 232;                                             % Elevation of sampling site [m asl.]
max_elev = 2073;                                             % Maximum elevation of the possible source area [m asl.] (note: bit lower than the highest peak of the area 2303)

%************* Landscape settings *************
rho_min = 2.5;                                               % Minimum rock density in source [g/cm3] 
rho_max = 2.7;                                              % Maximum rock density in source [g/cm3] 
min_ero = 1;                                                 % Minimum source erosion rate [m/Myr]
max_ero = 1000;                                             % Miximum source interglacial erosion rate [m/Myr]
%max_ero = 10;                                               % Maximum source interglacial erosion rate [m/Myr]
...
% pluck_min = 0.0001;                                            % Minimum plucking depth pr. glaciation [m] 
% pluck_max = 0.001;
%ice_lengths = 1000; 
ice_lengths = 1000; % Maximum potential length of a glaction at site [yr]
...
dt = 1000;                                                   % Timesteps in calculations [yr]
